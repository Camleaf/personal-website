...
function ProjectHero({name, imageEnd="jpg", timeframe="month xxxx - month xxxx", xOffset=-3, yOffset=-3, github="",extLink, description="Some important sample text"}:projectHeroProps){
    ...
    return (
        <motion.div layout className="w-full flex flex-col">
            <div className="flex flex-col lg:flex-row md:items-start sm:items-center bg-cl-gray-1 " ref={ref}>
                <div className="relative z-10 w-fit h-full lg:w-1/2 items-end justify-items-end hero-load sm:order-2 lg:order-1">
                ...
                <div className={"relative z-0 box-border w-fit h-fit overflow-hidden lg:w-1/2 flex flex-col items-start justify-start sm:order-1 lg:order-1"}>
                    <div className="pl-0 pt-8 lg:pl-8 sm:w-[100%] lg:w-auto h-full flex flex-col sm:items-center sm:justify-center md:items-start md:justify-start hero-text-load">
                        <Socials 
                            github={github}
                        />
