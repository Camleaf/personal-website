                ...
                <div className="mx-10 flex flex-row items-center">
                    ...
                    <div className = "flex flex-row gap-4 fixed right-8">
                        <div className="flex flex-row gap-4">
                            <a href="https://mail.google.com/mail/u/0/#inbox?compose=DmwnWrRpdTVwvHnQBhWZpDFrDlGKwJNJsNmPvnSSsQcGwXbltMwMVsJwjbrTfPVXWBcgVsjdLkBg" target="_blank" className="align-middle ease-out duration-200 cursor-pointer hover:brightness-[300%]"> 
                        <img src="/icons/emailLogo.svg" className="w-8 h-8 hover:scale-110 ease-out duration-200"/>
                    </a>
                    
                    {/* insta */}
                    <a href="https://www.instagram.com/_alexcedw/" target="_blank" className="align-middle ease-out duration-200 cursor-pointer hover:brightness-[300%]">
                        <img src="/icons/instagramLogo.svg" className="w-8 h-8 group-hover:scale-110 ease-out duration-200"/>
                    </a>

                    {/* github */}
                    <a href="https://github.com/camleaf" target="_blank" className="align-middle ease-out duration-200 cursor-pointer hover:brightness-[300%]">
